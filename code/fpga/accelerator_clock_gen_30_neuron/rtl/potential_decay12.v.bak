...
module potential_decay2(                            //input clock
	 input set_decay2,
	 input clear_decay2,
    ...
    input wire[31:0] new_potential2,             //input from the potential adder side
...
*/
 ...
 /*   wire[31:0] v_squared;     //v squared
    ...
    Addition_Subtraction Addition_Subtraction_decay_2(number_divided_by_2, number_divided_by_4, 1'b0, Exception, result_divide_by_2_plus_4);
	 ...
	 always @(posedge set_decay2) begin
		flip = ~flip;
	 end
    ...
    always @(flip, new_potential2) begin
	 
			if (set_decay2 == 1) begin
				membrane_potential = 32'h41DED852;
				neuron_address = 12'd0;
				decay_rate = 3'd1;
				model = 2'b00;
			end else begin
				membrane_potential = new_potential2;
			end
...
*/
    ...
    always @(clear_decay2, output_potential_decay2_LIF) begin
...
/*
		...
		//end
				...
				decayoutput0 = output_potential_decay2[0];
				decayoutput1 = output_potential_decay2[1];
				decayoutput2 = output_potential_decay2[2];
				decayoutput3 = output_potential_decay2[3];
				decayoutput4 = output_potential_decay2[4];
				decayoutput5 = output_potential_decay2[5];
				decayoutput6 = output_potential_decay2[6];
				decayoutput7 = output_potential_decay2[7];
				decayoutput8 = output_potential_decay2[8];
				decayoutput9 = output_potential_decay2[9];
    end
