...
module potential_decay4(                            //input clock
	 input set_decay4,
	 input clear_decay4,
    ...
    input wire[31:0] new_potential4,             //input from the potential adder side
...
*/
 ...
 /*   wire[31:0] v_squared;     //v squared
    ...
    Addition_Subtraction Addition_Subtraction_decay_4(number_divided_by_2, number_divided_by_4, 1'b0, Exception, result_divide_by_2_plus_4);
	 ...
	 always @(posedge set_decay4) begin
		flip = ~flip;
	 end
    ...
    always @(flip, new_potential4) begin
	 
			if (set_decay4 == 1) begin
				membrane_potential = 32'h41DED852;
				neuron_address = 12'd0;
				decay_rate = 3'd1;
				model = 2'b00;
			end else begin
				membrane_potential = new_potential4;
			end
...
*/
    ...
    always @(clear_decay4, output_potential_decay4_LIF) begin
...
/*
		...
		//end
				...
				decayoutput0 = output_potential_decay4[0];
				decayoutput1 = output_potential_decay4[1];
				decayoutput2 = output_potential_decay4[2];
				decayoutput3 = output_potential_decay4[3];
				decayoutput4 = output_potential_decay4[4];
				decayoutput5 = output_potential_decay4[5];
				decayoutput6 = output_potential_decay4[6];
				decayoutput7 = output_potential_decay4[7];
				decayoutput8 = output_potential_decay4[8];
				decayoutput9 = output_potential_decay4[9];
    end
