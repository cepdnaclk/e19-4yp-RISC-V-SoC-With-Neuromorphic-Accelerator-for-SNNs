...
module mac2(
    ...
    output reg[31:0] mult_output2,               //output of 32 bits to the adder
    ...
    always @(posedge clear_mac2) begin
        flip_clear = ~flip_clear;
    end

    always @ (posedge set_mac2) begin
			flip_set = ~flip_set;
	 end
	 
	 always @ (posedge set_source2) begin
    ...
    always @(set_mac2, flip_clear, source_address) begin
        ...
        if(set_mac2 == 1) begin
            ...
            if (clear_mac2 == 1'b1) begin
                ...
                case (spikes)
                    5'b00000: mult_output2 = 32'h00000000;
                    5'b00001: mult_output2 = 32'h4290B333;
                    5'b00010: mult_output2 = 32'h41975C29;
                    5'b00011: mult_output2 = 32'h42B68A3D;
                    5'b00100: mult_output2 = 32'h42470A3D;
                    5'b00101: mult_output2 = 32'h42F43851;
                    5'b00110: mult_output2 = 32'h42895C29;
                    5'b00111: mult_output2 = 32'h430D07AF;
                    5'b01000: mult_output2 = 32'h00000000;
                    5'b01001: mult_output2 = 32'h4290B333;
                    5'b01010: mult_output2 = 32'h41975C29;
                    5'b01011: mult_output2 = 32'h42B68A3D;
                    5'b01100: mult_output2 = 32'h42470A3D;
                    5'b01101: mult_output2 = 32'h42F43851;
                    5'b01110: mult_output2 = 32'h42895C29;
                    5'b01111: mult_output2 = 32'h430D07AF;
                    5'b10000: mult_output2 = 32'h42AE3851;
                    5'b10001: mult_output2 = 32'h431F75C3;
                    5'b10010: mult_output2 = 32'h42D40F5D;
                    5'b10011: mult_output2 = 32'h43326147;
                    5'b10100: mult_output2 = 32'h4308DEB9;
                    5'b10101: mult_output2 = 32'h43513851;
                    5'b10110: mult_output2 = 32'h431BCA3D;
                    5'b10111: mult_output2 = 32'h436423D7;
                    5'b11000: mult_output2 = 32'h42AE3851;
                    5'b11001: mult_output2 = 32'h431F75C3;
                    5'b11010: mult_output2 = 32'h42D40F5D;
                    5'b11011: mult_output2 = 32'h43326147;
                    5'b11100: mult_output2 = 32'h4308DEB9;
                    5'b11101: mult_output2 = 32'h43513851;
                    5'b11110: mult_output2 = 32'h431BCA3D;
                    5'b11111: mult_output2 = 32'h436423D7;
                    default: mult_output2 = 32'h00000000;
                endcase
					
						macoutput0 = mult_output2[0];
						macoutput1 = mult_output2[1];
						macoutput2 = mult_output2[2];
						macoutput3 = mult_output2[3];
						macoutput4 = mult_output2[4];
						macoutput5 = mult_output2[5];
						macoutput6 = mult_output2[6];
						macoutput7 = mult_output2[7];
						macoutput8 = mult_output2[8];
						macoutput9 = mult_output2[9];

            end

            if(clear_mac2 == 1'b0) begin
